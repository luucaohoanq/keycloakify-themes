...
import { createKcPageStory } from "../core/keycloak/KcPageStory";
import { MultiThemeView } from "./MultiThemeView";
...
export const BothThemes: Story = {
  render: () => (
    <MultiThemeView title="Login Page - Light and Dark Comparison">
      <KcPageStory />
    </MultiThemeView>
  ),
};
